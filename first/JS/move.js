...
function move(obj,json,options){
	...
	options.easing = options.easing || Tween.Quad.easeIn;
	...
	obj.timer=setInterval(function(){
		...
		for(var key in json){//办事部分包起来
            var cur=options.easing((n/count)*options.duration,start[key],dis[key],options.duration);
...
//
//Tween.Quad.easeIn   ==  函数体
//Tween.Quad.easeIn(t,b,c,d)  --> 返回  move里面cur
//t:    current Time        当前位置所花掉的时间（n/count）*duration
